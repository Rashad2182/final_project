                    ...
                    <div class="form-inner">
                        <form action="{{ route('home_banners.update' , ['home_banner'=>$homeBanner->id]) }}" method="POST" enctype="multipart/form-data" onsubmit="{{ route('home_banners.index') }}">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="lang" id="lang" class="form-select">
                                        @foreach(config('app.languages') as $code => $name)
                                            <option value="{{ $code }}"
                                                @selected(old('lang', $homeBanner->lang  ) == $code)>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input type="text" name="address" id="address"
                                               ...
                                               value="{{ old('address', $homeBanner->address) }}">
                                    </div>
                                    @error('address')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input type="text" name="phone" id="phone"
                                               ...
                                               value="{{ old('phone', $homeBanner->phone) }}">
                                    </div>
                                    @error('phone')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                <button type="submit" name="save" class="btn btn-gradient px-4">
